...
public class YbSyncPlugin implements IBackgroundWorkPlugin {
	...
	public PreAlertObject executeTask(BgWorkingContext arg0)
		...
		hmp.put("group", group);
		hmp.put("nc_voucher", (String) km.get("nc_voucher"));
		...
		try {
			NCLocator.getInstance().lookup(YbAgVoucherSyncItf.class)
					.exesoVoucher(hmp);
